...
public class ResumeHonorAdapter extends ListViewCommonAdapterWithoutdiv<ResumeHonorDetail> {
    /**
     ...
     */
    public ResumeHonorAdapter(Context context, String listIteam_LayoutName, ResumeHonorDetail[] IteamDatas) {
     ...
     */
    @Override
    public void setIteamView(ResumeHonorDetail iteamData) {
        // TODO 根据列表项数据iteamData，设置列表项的显示

        TextView tv_honor = (TextView) IteamView("resume_honor_text");
        if (iteamData.honor != ""){
            tv_honor.setText(iteamData.honor);
        }
     ...
     */
    @Override
    public void setIteamClick(Context iteamContext, ResumeHonorDetail iteamData) {
        // TODO 根据列表项数据iteamData，设置列表项的点击处理逻辑
        // View view = IteamView("name"); //获取列表项中，指定名称的view
        Log.e("ResumeHonorAdapter","点击列表的id:"+iteamData.id);
